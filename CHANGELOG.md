...
## [Unreleased]
### Changed
- Updated dependencies of lib-qmt.js.
### Fixed
- Stop using the `use_line_collection` parameter of `plt.stem` in `qmt.syncOptImu_debugPlot` (removed in matplotlib 3.8).
...
[0.2.4]: https://github.com/dlaidig/qmt/compare/v0.2.3...v0.2.4
